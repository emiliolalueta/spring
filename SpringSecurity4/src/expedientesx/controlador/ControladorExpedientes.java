...
public class ControladorExpedientes {
	...
	@Autowired 
	private GestorExpendientes gestorExpendientes;
	...
	public ModelAndView mostrarTodos() {
		...
		mav.addObject("expedientes", gestorExpendientes.listarTodos());
		return mav;
	}
	...
	public ModelAndView mostrar(@PathVariable Long id) {
		...
		mav.addObject("expediente", gestorExpendientes.mostrar(id));
		return mav;
	}
	...
	public String clasificar( @RequestParam("id") Long id, Model model){
		...
		Expediente expediente = gestorExpendientes.mostrar(id);
		gestorExpendientes.clasificar(expediente);
	...
	public String desclasificar( @RequestParam("id") Long id, Model model){
		...
		Expediente expediente = gestorExpendientes.mostrar(id);
		gestorExpendientes.desclasificar(expediente);
		return "redirect:/expedientesx/mostrar/todos";
	}
